...
ADD COLUMN IF NOT EXISTS show_in_candidate_status boolean NOT NULL DEFAULT true,
ADD COLUMN IF NOT EXISTS show_in_internal boolean NOT NULL DEFAULT true;

-- Preserve previous behaviour:
-- Candidate status had followed dashboard visibility, while internal update
-- status had followed is_active visibility.
UPDATE public.fields
SET show_in_candidate_status = show_in_dashboard
WHERE show_in_candidate_status IS DISTINCT FROM show_in_dashboard;
...
SET
  ...
  show_in_candidate_status = false,
