...
VALUES ('00000000-0000-0000-0000-000000000001', 'Local Admin', 'admin')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.record_values (record_id, field_id, value_text, value_select) VALUES
    ...
    ('30000000-0000-0000-0000-000000000002','20000000-0000-0000-0000-000000000002', 'alice@example.com',   NULL),
    ...
    ('30000000-0000-0000-0000-000000000003','20000000-0000-0000-0000-000000000002', 'bob@example.com',     NULL),
    ...
    ('30000000-0000-0000-0000-000000000004','20000000-0000-0000-0000-000000000002', 'carol@example.com',   NULL),
    ...
    ('30000000-0000-0000-0000-000000000005','20000000-0000-0000-0000-000000000002', 'david@example.com',   NULL),
    ...
    ('30000000-0000-0000-0000-000000000006','20000000-0000-0000-0000-000000000002', 'emma@example.com',    NULL),
    ...
    ('30000000-0000-0000-0000-000000000007','20000000-0000-0000-0000-000000000002', 'frank@example.com',   NULL),
    ...
    ('30000000-0000-0000-0000-000000000008','20000000-0000-0000-0000-000000000002', 'grace@example.com',   NULL),
    ...
    ('30000000-0000-0000-0000-000000000009','20000000-0000-0000-0000-000000000002', 'henry@example.com',   NULL),
    ...
    ('30000000-0000-0000-0000-000000000010','20000000-0000-0000-0000-000000000002', 'isabella@example.com',NULL),
    ...
    ('30000000-0000-0000-0000-000000000011','20000000-0000-0000-0000-000000000002', 'james@example.com',   NULL),
    ...
    ('30000000-0000-0000-0000-000000000012','20000000-0000-0000-0000-000000000002', 'karen@example.com',   NULL),
